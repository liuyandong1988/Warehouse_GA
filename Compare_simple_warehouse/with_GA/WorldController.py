    ...
    def timerController(self):
        ...
        for i in self.agents:
            ...
            if cnt == NUM_AGENTS and self.stop_mark == 0 :
                ...
                print 'Best chromosome:', GA_allocate.best_chromosome
                print 'Task allocation:', GA_allocate.task_allocation_record
                print 'Each agent distance:',GA_allocate.each_agent_distance
                print 'The total distance:',GA_allocate.distance_total
